                    ...
                    {SECTIONS.map((section) => {
                        ...
                        return (
                            <button
                                ...
                                className={`w-full group flex items-center justify-between py-2.5 sm:py-3 lg:py-3.5 px-3 sm:px-4 lg:px-5 rounded-xl sm:rounded-2xl transition-all ${activeNav === section.id
                            ...
                            >
                                <div className="flex items-center gap-2.5 sm:gap-3 lg:gap-3.5">
                                    <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full transition-all duration-500 flex-shrink-0 ${activeNav === section.id
                                        ? 'bg-white active-dot'
                                        : status?.isComplete
                                            ? 'bg-[#d6b499]'
                                            : 'bg-slate-700'
                                ...
                                {status?.isComplete && activeNav !== section.id && (
                                    <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-tan-text flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
