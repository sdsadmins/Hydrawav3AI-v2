    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 w-full">
      ...
      <div className="space-y-2 sm:space-y-3">
        ...
        <input
          ...
          className="w-full compact-input rounded-xl sm:rounded-2xl px-4 sm:px-5 py-3 sm:py-3.5 text-sm font-medium"
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3">
          {['Male', 'Female', 'Intersex', 'Prefer not to say'].map(opt => (
            <button
              ...
              className={`px-4 sm:px-5 py-2.5 sm:py-3.5 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-semibold transition-all border whitespace-nowrap flex-1 sm:flex-none min-w-[120px] sm:min-w-0 ${formData.sexAtBirth === opt
